...
NDiplomacy = {
	...
	TRUCE_PERIOD_AFTER_KICKING_FROM_FACTION = 15,				-- Truce period after kicking someone from faction in days.
	...
	VOLUNTEERS_DIVISIONS_REQUIRED = 10,				-- This many divisons are required for the country to be able to send volunteers.
...
NCountry = {
	...
	MIN_MAJOR_COUNTRIES	= 5,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
	...
	COUNTRY_LEADER_FEMALE_CHANCE = 0.3, -- chance for new country leaders to be female. should be set > 0 only if there are portraits/names for that country
